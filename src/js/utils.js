...
*/
	...
	function t(a, b) {
		for (let c = oa(a.j()), d = 0; d < c.length; d++) {
			let e = c[d];
				const g = e.g;
			if (b.g[g] != null) {
				a.i && delete a.i[e.g];
				...
				if (e.m) {
					e = u(b, g);
					for (let h = 0; h < e.length; h++) r(a, g, f ? e[h].clone() : e[h]);
				} else
					(e = v(b, g)),
	...
	function y(a, b) {
		const c = [];
			let d;
		for (d in b) d != 0 && c.push(new ea(d, b[d]));
		return new na(a, c);
	}
	function A() {}
	...
	A.prototype.i = function (a, b) {
		...
		if (a.i == 14)
			return typeof b === 'string' && B.test(b) && ((a = Number(b)), a > 0)
				? a
				: b;
		if (!a.u) return b;
		a = a.v;
		if (a === String) {
			...
			a === Number &&
			typeof b === 'string' &&
			(b === 'Infinity' || b === '-Infinity' || b === 'NaN' || B.test(b))
		)
			return Number(b);
		return b;
	};
	...
	D.prototype.i = function (a, b) {
		return a.i == 8 ? !!b : A.prototype.i.apply(this, arguments);
	};
...
*/
	...
	m(I, n);
	let sa = null;
		const ta = { ea: 0, da: 1, ca: 5, ba: 10, aa: 20 };
...
*/
	...
	const wa = {
		...
		const L = /^[+\uff0b]+/;
		const ya = /([0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9])/;
		const za = /[+\uff0b0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]/;
		const Aa = /[\\\/] *x/;
		const Ba = /[^0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9A-Za-z#]+$/;
		const Ca = /(?:.*?[A-Za-z]){3}.*/;
	function N(a) {
	...
	const Ea = new RegExp('(?:' + Da() + ')$', 'i');
		...
		const Ga = /(\$\d)/;
	function Ha(a) {
		return a.length < 2 ? !1 : O(Fa, a);
	}
	function Ia(a) {
		return O(Ca, a) ? P(a, xa) : P(a, wa);
	}
	function Ja(a) {
		const b = Ia(a.toString());
		a.i = '';
		a.g(b);
	}
	function Ka(a) {
		return a != null && (x(a, 9) != 1 || u(a, 9)[0] != -1);
	}
	function P(a, b) {
		for (var c = new E(), d, e = a.length, g = 0; g < e; ++g)
			(d = a.charAt(g)), (d = b[d.toUpperCase()]), d != null && c.g(d);
		return c.toString();
	}
	function Q(a) {
		return a != null && isNaN(a) && a.toUpperCase() in va;
	}
	function La(a, b, c) {
		if (p(b, 2) == 0 && b.g[5] != null) {
			var d = w(b, 5);
			if (d.length > 0) return d;
		}
		d = w(b, 1);
		let e = R(b);
		if (c == 0) return Ma(d, 0, e, '');
		if (!(d in J)) return e;
		a = S(a, d, T(d));
		b =
			b.g[3] != null && p(b, 3).length != 0
				? c == 3
					? ';ext=' + p(b, 3)
					: a.g[13] != null
					? p(a, 13) + w(b, 3)
				...
				: '';
		a: {
			a = u(a, 20).length == 0 || c == 2 ? u(a, 19) : u(a, 20);
			for (var g, f = a.length, h = 0; h < f; ++h) {
				g = a[h];
				let l = x(g, 3);
				if (l == 0 || e.search(p(g, 3, l - 1)) == 0)
	...
	function S(a, b, c) {
		return c == '001' ? U(a, '' + b) : U(a, c);
	}
	function R(a) {
		if (a.g[2] == null) return '';
		const b = '' + p(a, 2);
		return a.g[4] != null && p(a, 4) && w(a, 8) > 0
	...
	function X(a, b) {
		const c = a.length;
		return x(b, 9) > 0 && u(b, 9).indexOf(c) == -1 ? !1 : O(w(b, 2), a);
	}
	function Na(a, b) {
		if (b == null) return null;
		let c = w(b, 1);
	...
	function Y(a, b, c, d) {
		let e = V(c, d);
			let g = x(e, 9) == 0 ? u(p(c, 1), 9) : u(e, 9);
		e = u(e, 10);
		if (d == 2)
			if (Ka(V(c, 0)))
				(a = V(c, 1)),
					Ka(a) &&
						((g = g.concat(x(a, 9) == 0 ? u(p(c, 1), 9) : u(a, 9))),
						g.sort(),
						e.length == 0
							? (e = u(a, 10))
	...
	function Pa(a, b, c, d, e, g) {
		...
		if (h.length == 0) f = 20;
			...
			if (f.search(h) == 0) {
				...
				l && l[1] != null && l[1].length > 0 && P(l[1], wa) == '0'
					? (f = !1)
		...
		e && q(g, 6, f);
		if (f != 20) {
			if (b.i.length <= 2) throw Error('Phone number too short after IDD');
			a: {
				a = b.toString();
				if (a.length != 0 && a.charAt(0) != '0')
					for (e = a.length, b = 1; b <= 3 && b <= e; ++b)
		...
		if (
			...
			l.lastIndexOf(h, 0) == 0 &&
				...
				Qa(h, c, null),
				(h = h.toString()),
				(!O(l, b.toString()) && O(l, h)) || Y(a, b.toString(), c, -1) == 3))
		)
	...
	function Qa(a, b, c) {
		let d = a.toString();
			let e = d.length;
			let g = p(b, 15);
		if (e != 0 && g != null && g.length != 0) {
			const f = new RegExp('^(?:' + g + ')');
			if ((e = f.exec(d))) {
				...
				if (b == null || b.length == 0 || e[l] == null || e[l].length == 0) {
					if (!h || O(g, d.substring(e[0].length)))
						c != null && l > 0 && e[l] != null && c.g(e[1]),
							a.set(d.substring(e[0].length));
				} else if (((d = d.replace(f, b)), !h || O(g, d)))
					c != null && l > 0 && c.g(e[1]), a.set(d);
			}
		}
	}
	function Z(a, b, c) {
		if (!Q(c) && b.length > 0 && b.charAt(0) != '+')
			throw Error('Invalid country calling code');
		return Ra(a, b, c, !0);
	}
	function Ra(a, b, c, d) {
		...
		let e = new E();
			let g = b.indexOf(';phone-context=');
		if (g >= 0) {
			var f = g + 15;
			if (b.charAt(f) == '+') {
				var h = b.indexOf(';', f);
				h > 0 ? e.g(b.substring(f, h)) : e.g(b.substring(f));
			}
			f = b.indexOf('tel:');
			e.g(b.substring(f >= 0 ? f + 4 : 0, g));
		} else
			(g = e.g),
				(f = b.search(za)),
				f >= 0
					? ((f = b.substring(f)),
					  (f = f.replace(Ba, '')),
					  (h = f.search(Aa)),
					  h >= 0 && (f = f.substring(0, h)))
					: (f = ''),
				g.call(e, f);
		g = e.toString();
		f = g.indexOf(';isub=');
		f > 0 && ((e.i = ''), e.g(g.substring(0, f)));
		if (!Ha(e.toString()))
			throw Error('The string supplied did not seem to be a phone number');
		g = e.toString();
		if (!(Q(c) || (g != null && g.length > 0 && L.test(g))))
			throw Error('Invalid country calling code');
		g = new I();
		d && q(g, 5, b);
		a: {
		...
		try {
			...
			if (M.message == 'Invalid country calling code' && L.test(l)) {
				if (((l = l.replace(L, '')), (h = Pa(a, l, f, b, d, g)), h == 0))
					throw M;
			} else throw M;
		}
		h != 0
		...
		f != null &&
			...
			a != 2 &&
				a != 4 &&
				a != 5 &&
				((b = e), d && c.toString().length > 0 && q(g, 7, c.toString())));
		d = b.toString();
		a = d.length;
		if (a < 2)
			throw Error('The string supplied is too short to be a phone number');
	...
	function O(a, b) {
		return (a =
			typeof a === 'string' ? b.match('^(?:' + a + ')$') : b.match(a)) &&
			a[0].length == b.length
			? !0
			: !1;
	}
	...
	k('intlTelInputUtils.formatNumber', function (a, b, c) {
		try {
			const d = K.g();
				const e = Z(d, a, b);
				const g = Oa(d, e);
			return g == 0 || g == 4 ? La(d, e, typeof c === 'undefined' ? 0 : c) : a;
		} catch (f) {
			return a;
		}
	});
	...
	k('intlTelInputUtils.getValidationError', function (a, b) {
		try {
			...
			return e.message == 'Invalid country calling code'
				? 1
	...
	k('intlTelInputUtils.isValidNumber', function (a, b) {
		try {
			...
			if (!(h = f == null)) {
				...
				if ((l = e != '001')) {
					const z = U(c, e);
					if (z == null) throw Error('Invalid region code: ' + e);
					const M = w(z, 10);
					l = g != M;
				}
				h = l;
